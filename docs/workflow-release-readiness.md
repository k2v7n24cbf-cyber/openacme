...
Executable workflow source proven by final test-env smoke: `074d20c`

Later commits are documentation-only unless this matrix, the planning brief, or
the production rollout runbook explicitly says otherwise.
